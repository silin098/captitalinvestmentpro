<footer class="d-flex flex-wrap justify-content-between align-items-center my-5 ">
    <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0">{{now()->year}} Capitalinvestmentpro, Inc</span>
    </div>
