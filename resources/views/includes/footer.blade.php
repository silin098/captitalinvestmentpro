<footer class="d-flex flex-wrap justify-content-between align-items-center p-3 my-4 border-top border-secondary">
    ...
    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex me-md-5">
        ...
        <li>
            <a  class="ms-3 text-light me-2 me-md-2" href="https://t.me/JayK454" target="_blank"><i class="fa-brands fa-telegram fa-2xl"></i></a>
        </li>
        <li>
            <a  class="ms-2 text-light me-md-2" href="https://wa.me/+66612790081" target="_blank"><i class="fa-brands fa-whatsapp fa-2xl"></i></a>
        </li>
