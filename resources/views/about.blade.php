        ...
        <div class="text-light">
            ...
            <div class="row mt-5">
                <div class="col-md-6 mb-3">
                    <div class="card-for-about p-4 rounded-4">
                        <h5>Proven Track Record</h5>
                        <p class="text-secondary lh-lg">We have a track record of successful cryptocurrency investments. Our team of experts has a deep understanding of the market, enabling us to make informed decisions and generate significant returns for our clients.</p>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="card-for-about p-4 rounded-4">
